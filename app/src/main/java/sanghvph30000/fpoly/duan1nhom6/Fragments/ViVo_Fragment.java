...
public class ViVo_Fragment extends Fragment {
    private RecyclerView recyclerView;
    private SanPhamDAO sanPhamDAO;
    public ViVo_Fragment() {
        // Required empty public constructor
    }



    public static ViVo_Fragment newInstance() {
        ViVo_Fragment fragment = new ViVo_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_vivo, container, false);
    }
